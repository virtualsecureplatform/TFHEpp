export module tfhepp:params:128bit;
import std;
// This file defines parameters. It might need to import tfhepp:params if ErrorDistribution is defined there.
// Assuming ErrorDistribution is made available by tfhepp:params main module interface file, or it's defined within each param file set.
// For now, let's assume tfhepp:params (params.ixx) will export ErrorDistribution.
// If TFHEpp::ErrorDistribution is used, then an import might be needed.
// However, these structs are defining parameters, likely without direct TFHEpp namespace usage inside.
...
export struct Annihilatelvl1param {

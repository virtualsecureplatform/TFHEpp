export module tfhepp:params:compress;
import std;
// import tfhepp:params; // For TFHEpp::ErrorDistribution

export constexpr bool isternary = false;
...
export struct lvl1param {
    ...
    static constexpr TFHEpp::ErrorDistribution errordist =
        TFHEpp::ErrorDistribution::CenteredBinomial;

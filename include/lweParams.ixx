export module tfhepp:lweParams;
import std;

export import tfhepp:params;

export namespace TFHEpp {
export struct portablelvl0param {
...
export struct portablelvl1param {
...
export struct portablelvl2param {
    std::uint32_t nbit;  // dimension must be a power of 2 for ease of
                         // polynomial multiplication.
    std::uint32_t n;     // dimension
    std::uint32_t l;
...
export struct portablelvl10param {
...
export struct portablelvl20param {
    std::uint32_t t;  // number of addition in keyswitching
    std::uint32_t
        basebit;  // how many bit should be encrypted in keyswitching key
    double α;     // key noise
...
export struct portablelvl21param {
    std::uint32_t t;  // number of addition in keyswitching
    std::uint32_t
        basebit;  // how many bit should be encrypted in keyswitching key
...
export struct portablelvl22param {
    std::uint32_t t;  // number of addition in keyswitching
    std::uint32_t
        basebit;  // how many bit should be encrypted in keyswitching key
    // double α;     // key noise

export module tfhepp:gate;
import std;

export import tfhepp:cloudkey;
export import tfhepp:gatebootstrapping;
export import tfhepp:keyswitch;
export import tfhepp:params;
export import tfhepp:tlwe;
export import tfhepp:trlwe;

export namespace TFHEpp {
export template <class brP, typename brP::targetP::T μ, class iksP, int casign,
...
export template <class iksP, class brP, typename brP::targetP::T μ, int casign,
...
// No input
export template <class P = lvl1param>
...
export template <class brP = lvl01param, typename brP::targetP::T μ = lvl1param::μ,
...
export template <class iksP = lvl10param, class brP = lvl01param,
                      ...
                      const TLWE<typename bkP::domainP> &c0, const EvalKey &ek)
{
    ...
    temp1[lvl0param::n] -= bkP::domainP::μ; // Needs lvl0param to be defined via params import
    temp0[lvl0param::n] -= bkP::domainP::μ; // Needs lvl0param to be defined via params import
...
export template <class brP, typename brP::targetP::T μ = brP::targetP::μ>
                ...
                const TLWE<typename brP::domainP> &c0, const EvalKey &ek)
{
    ...
    for (int i = 0; i < brP::targetP::k * brP::targetP::n; i++) { // Should likely be brP::targetP::k * brP::targetP::n
...
export template <class iksP, class brP, typename brP::targetP::T μ = brP::targetP::μ>
void HomMUXwoSE(TRLWE<typename brP::targetP> &res,
...
export void ExtractSwitchAndHomMUX(TRLWE<lvl1param> &res, const TRLWE<lvl1param> &csr,

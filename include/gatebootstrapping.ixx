export module tfhepp:gatebootstrapping;
import std;

export import tfhepp:cloudkey;
export import tfhepp:detwfa;
export import tfhepp:keyswitch;
export import tfhepp:params;
export import tfhepp:trlwe;
export import tfhepp:trgsw; // For TRGSWFFT used in KeyBundleFFT
import tfhepp:utils;

#ifdef USE_KEY_BUNDLE
export import tfhepp:keybundle;
#endif

export namespace TFHEpp {

export template <class P, uint32_t num_out = 1>
...
export template <class P, uint32_t num_out>
...
export template <class P, typename P::T μ>
...
export template <class bkP, typename bkP::targetP::T μ, class iksP>
...
export template <class iksP, class bkP, typename bkP::targetP::T μ>
...
export template <class bkP, typename bkP::targetP::T μ, class iksP>
void GateBootstrappingNTT(TLWE<typename iksP::targetP> &res, // Typo tagetP -> targetP
                          const TLWE<typename bkP::domainP> &tlwe,
                          const EvalKey &ek)
{
    alignas(64) TLWE<typename bkP::targetP> tlwelvl1;

...
export template <class P, uint32_t address_bit>
void RAMUX(TRLWE<P> &res, const std::array<TRGSWFFT<P>, address_bit> &invaddress,
           const std::array<TRLWE<P>, 1 << address_bit> &data)
{
    constexpr uint32_t num_trlwe = 1 << address_bit;
    std::array<TRLWE<P>, num_trlwe / 2> temp;
...
export template <class P, uint32_t address_bit, uint32_t width_bit>
void UROMUX(TRLWE<P> &res, const std::array<TRGSWFFT<P>, address_bit> &invaddress,
            const std::array<TRLWE<P>, 1 << (address_bit - width_bit)> &data)
{
...
export template <class P, uint32_t address_bit, uint32_t width_bit>
void LROMUX(std::vector<TLWE<P>> &res,
            const std::array<TRGSWFFT<P>, address_bit> &address,
            const TRLWE<P> &data)
{
    TRLWE<P> temp, acc;

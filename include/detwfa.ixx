export module tfhepp:detwfa;
import std;

export import tfhepp:trgsw;
export import tfhepp:trlwe;
export import tfhepp:params;
export import tfhepp:gatebootstrapping; // For BootstrappingKeyElementFFT
...
export alignas(64) const TRGSWFFT<lvl1param> trgswonelvl1 =
    TRGSWFFTOneGen<lvl1param>();
export alignas(64) const TRGSWFFT<lvl2param> trgswonelvl2 =

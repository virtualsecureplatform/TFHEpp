export module tfhepp:nussbaumer;
import std; // For std::span, std::array, std::copy

export namespace Nussbaumer {

export template <typename T, uint rbit>
...
export template <typename T, uint mbit, uint rbit>
...
export template <typename T, uint Nbit>

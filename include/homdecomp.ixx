 ...
 * the base value
 */
export template <class P, uint basebit>
 ...
 */
export template <class high2midP, class mid2lowP, class brP, uint basebit,
          uint numdigit>

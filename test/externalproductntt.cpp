...
int main()
{
    ...
    for (int test = 0; test < num_test; test++) {
        ...
        TFHEpp::TRLWE<TFHEpp::lvl1param> c =
            TFHEpp::trlweSymEncrypt<TFHEpp::lvl1param>(pmu, TFHEpp::lvl1param::α, key.lvl1);

        const TFHEpp::Polynomial<TFHEpp::lvl1param> plainpoly = {static_cast<typename TFHEpp::lvl1param::T>(1)};

        TFHEpp::TRGSWNTT<TFHEpp::lvl1param> trgswntt =
            TFHEpp::trgswnttSymEncrypt<TFHEpp::lvl1param>(plainpoly, TFHEpp::lvl1param::α, key.lvl1);
